...
SQLite schema v6 adds approval-gated tips, bounded evidence, review history and rule-application audit while preserving all v5 resources, modalities, notifications and daily reports. Failed candidate images are temporary files and are never retained.
